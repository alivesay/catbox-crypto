...
exports = module.exports = internals.Connection = function (options) {
  ...
  this.settings.engine = this.settings.engine || require('catbox-memory');

  this.settings.key = randomEnoughBytes(this.settings.keySize);

  if (typeof this.settings.engine === 'object') {
